<main class="bg-black p-3">
    <div class="container text-center">
        ...
        <div>
            <form id="msg">
                <textarea style="outline: none;" class="w-100 p-3" name="text" cols="30" rows="10" placeholder="Напишите что-нибудь"></textarea>
    ...
    <div class="container">
        ...
        <div class="list">
            ...
            <div class="bg-dark row mb-3 p-1">
                <div class="info text-warning">24.04.2020 0:19</div>
                <div class="text text-light">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iure fuga repellendus eius? Corporis numquam repellat nihil cupiditate optio eius voluptates repudiandae ut iure nesciunt? Temporibus saepe ab doloribus cupiditate ex asperiores ipsa a natus odit quia ratione earum incidunt molestiae, ipsam reprehenderit et recusandae, placeat exercitationem. Veniam mollitia perferendis debitis!</div>
            </div>
            <div class="bg-dark row mb-3 p-1">
